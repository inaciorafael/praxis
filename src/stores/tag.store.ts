...
import type { CreateTagInput, Tag, TagCollection, TaskTag, UpdateTagInput } from "@/shared/types/tag";
  ...
  actions: {
    ...
    async hydrate() {
      try {
        ...
        this.error = error instanceof Error ? error.message : "Abra o cofre para carregar tags.";
      }
    },
    ...
    async create(input: CreateTagInput) {
      try {
        ...
        this.error = error instanceof Error ? error.message : "Nao foi possivel criar a tag.";
        return false;
      }
    },
    ...
    async update(id: string, input: UpdateTagInput) {
      try {
        ...
        this.error = error instanceof Error ? error.message : "Nao foi possivel atualizar a tag.";
        return false;
      }
    },
    ...
    async delete(id: string) {
      try {
        ...
        this.error = error instanceof Error ? error.message : "Nao foi possivel remover a tag.";
      }
    },
    ...
    async assignToTask(taskId: string, tagId: string) {
      try {
        ...
        this.error = error instanceof Error ? error.message : "Nao foi possivel atribuir a tag.";
      }
    },
    ...
    async removeFromTask(taskId: string, tagId: string) {
      try {
        ...
        this.error = error instanceof Error ? error.message : "Nao foi possivel remover a tag da tarefa.";
      }
    },
