...
import { clearBadgeCount, getBadgeCount, setBadgeCount } from "@/shared/lib/badge/badge.service";
  ...
  actions: {
    ...
    async hydrate() {
      try {
        ...
        this.error = error instanceof Error ? error.message : "Nao foi possivel carregar o badge.";
      }
    },
    ...
    async setCount(count: number) {
      try {
        ...
        this.error = error instanceof Error ? error.message : "Nao foi possivel atualizar o badge.";
      }
    },
    ...
    async clear() {
      try {
        ...
        this.error = error instanceof Error ? error.message : "Nao foi possivel limpar o badge.";
      }
    },
  },
});
