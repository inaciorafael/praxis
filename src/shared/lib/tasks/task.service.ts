...
export async function generateDueRecurringTasks() {
  return invoke<TaskCollection>('generate_due_recurring_tasks', {
    today: todayLocalDate(),
  })
}

export async function listTodayTasks(options?: TaskListOptions) {
  return invoke<TaskListResult>('list_today_tasks', {
    today: todayLocalDate(),
    options,
  })
}
...
export async function listPendingTasks(options?: TaskListOptions) {
  return invoke<TaskListResult>('list_pending_tasks', {
    today: todayLocalDate(),
    options,
  })
}
...
export async function listOverdueTasks(options?: TaskListOptions) {
  return invoke<TaskListResult>('list_overdue_tasks', {
    today: todayLocalDate(),
    options,
  })
}
...
export async function listUpcomingTasks(options?: TaskListOptions) {
  return invoke<TaskListResult>('list_upcoming_tasks', {
    today: todayLocalDate(),
    options,
  })
}
...
export async function listReminderTasks(options?: TaskListOptions) {
  return invoke<TaskListResult>('list_reminder_tasks', {
    today: todayLocalDate(),
    options,
  })
}
...
export async function listCompletedTasks(options?: TaskListOptions) {
  return invoke<TaskListResult>('list_completed_tasks', {
    today: todayLocalDate(),
    options,
  })
}
...
export async function searchTasks(filters: TaskSearchFilters, options?: TaskListOptions) {
  return invoke<TaskSearchResult>('search_tasks', {
    today: todayLocalDate(),
    filters,
    options,
  })
